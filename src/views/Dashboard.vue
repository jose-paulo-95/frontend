        ...
        >
          <div class="card">
            ...
            <footer class="card-footer">
              ...
              <a href="#" class="card-footer-item btn-remove" @click="remove(contact._id)"
                >Apagar</a
              >
            </footer>
          </div>
          ...
          <div class="modal-card" style="width: 450px">
            ...
            <section class="modal-card-body">
              ...
              <div class="field input-number">
                ...
                />
                <small class="has-text-danger" v-if="errorNamber === true"
